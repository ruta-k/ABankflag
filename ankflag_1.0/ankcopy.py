...
srcname		=	'/data/apurba/egs_50/msfiles/egs_50_t4_avg_uvsub_out.fits'				#	Input FITS file (FG TABLE IS NOT READ!)
targetname	=	'/data/apurba/egs_50/msfiles/egs_50_t4_avg.fits'				#	Target FITS file
outname		=	'/data/apurba/egs_50/msfiles/egs_50_t4_avg_out.fits'			#	Output FITS file
