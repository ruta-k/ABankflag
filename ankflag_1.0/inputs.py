infilename		=	'test.fits'		#	Name of the input FITS file
outfilename		=	'test_out.fits'	#	Name of the output file
...
BASEFLAGMEAN	=	['mean_rms',	1.3,	1.1,	0.01]		#	[FLAGON,	tolerance_mean,	tolearnce_rms,	min fraction]]			ONLY for 'baseline'
...
FLAGPARS=	[	[ 'chan_ind',	'mean',		'median',	'am',	1.4,	0.2,	2,	'',				0,	0,	0.0,	0.0],
			...
			[ 'rec_block',	'mean',		'mean',		'am',	1.0,	0.5,	2,	'ascending',	0,	2,	0.0,	0.05]	]
